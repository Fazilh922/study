		...
		<div class="container-fluid">
					...
					<div class="widget-card widget-bg3">		
						<div class="wc-item">
							...
							<span class="wc-stats counter">
								<span class="counter">
									<?php
                                        $result = $db->prepare("select count(*) from exam");
                                        $result->execute();
                                        for($i=0; $row = $result->fetch(); $i++)
                                        {
                                            echo"".$row['count(*)']."";
			...
			<div class="row">
				...
				<div class="col-lg-8 m-b30">
					<!-- Start -->
                        <?php
                        $result = $db->prepare("select * from contestattend where Log_Id='$Log_Id' and status='Pending'");
                        $result->execute();
					...
					<div class="widget-box">
						...
						<div class="widget-inner">
							<div class="noti-box-list">
								<ul>
									<?php
									$result = $db->prepare("select * from user_post limit 3");
									$result->execute();
									$row_count =  $result->rowcount();
									for($i=0; $rows = $result->fetch(); $i++)
									{
									...
									<li>
										...
										<span class="notification-text">
											<a href="material_viiew.php<?php echo '?sname='.$rows['sname'];?>"><?php echo $rows['sname'];?></a> 
										</span>
										<span class="notification-time">
											<a href="material_viiew.php<?php echo '?sname='.$rows['sname'];?>" class="fa fa-close"></a>
