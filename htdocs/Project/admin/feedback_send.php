<?php
	...
	$msg_id=$_GET['msg_id'];
	$result = $db->prepare("select * from feedback where msg_id='$msg_id'");
	$result->execute();
						...
						<div class="email-wrapper">
							<div class="email-menu-bar">
								<div class="compose-mail">
									<a href="feedback_view.php" class="btn btn-block">Compose</a>
								</div>
							...
							<div class="mail-list-container">
								<form class="mail-compose" method="post" action="action/feedback_send.php">
